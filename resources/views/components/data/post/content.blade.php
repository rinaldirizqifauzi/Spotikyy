<div class="table-responsive">
    <table class="table align-items-center mb-0">
        ...
        <tr>
            ...
            <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7 ps-2">Nama Band</th>
        ...
        <tbody>
            <?php $no = 1 ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm text-center">{{ $field->bands->nama }}</h6>
                        </div>
                    </td>
                    <td>
                        <a href="{{ route('posting.show', $field->id) }}" class="btn btn-xs mb-1 btn-info">Show </a>
                        <a href="{{ route('posting.edit', $field->id) }}" class="btn btn-xs mb-1 btn-warning">Edit </a>
                        <a href="{{ route('posting.delete', $field->id) }}" class="btn btn-xs mb-1 btn-danger" onclick="return confirm('Apa Kamu Yakin Menghapus Data Ini')">Hapus</a>
                    </td>
                <tr>
                @endforeach
        </tbody>
